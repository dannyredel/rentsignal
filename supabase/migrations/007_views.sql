-- ============================================================
-- 007: Views for portfolio dashboard queries
-- These denormalize units + latest analysis for fast reads.
-- ============================================================

-- Latest analysis per unit per type
-- Used by: /portfolio/summary, /portfolio/compliance-risk, /portfolio/revenue-gaps
CREATE OR REPLACE VIEW public.units_with_latest_analysis AS
SELECT
  u.id AS unit_id,
  u.user_id,
  u.label,
...
-- Portfolio summary (aggregated per user)
-- Used by: /portfolio/summary
